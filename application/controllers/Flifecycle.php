...
class Flifecycle extends CI_Controller {
  ...
  {
    //Page title
    $data['title'] = '- '.$this->lang->line('f_lifecycle').' - Pigs';
  ...
  {
    //Page title
    $data['title'] = '- '.$this->lang->line('f_lifecycle').' - Cattles';
  ...
  {
    //Page title
    $data['title'] = '- '.$this->lang->line('f_lifecycle').' - Pets';
    ...
    $this->load->view('template/header', $data);
    $this->load->view('frontend/life_cycles_pets', $data);
    $this->load->view('template/footer', $data);
  }
}
